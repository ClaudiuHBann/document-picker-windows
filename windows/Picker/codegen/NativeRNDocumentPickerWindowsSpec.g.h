...
struct RNDocumentPickerWindowsSpec : winrt::Microsoft::ReactNative::TurboModuleSpec {
  ...
  static constexpr void ValidateModule() noexcept {
    constexpr auto methodCheckResults = CheckMethods<TModule, RNDocumentPickerWindowsSpec>();
